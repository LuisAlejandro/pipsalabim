...
# -*- coding: utf-8 -*-
#
# pipsalabim documentation build configuration file, created by
...
project = u'Pip Sala Bim'
copyright = u'2016-2022, Pip Sala Bim Developers'
...
version = pipsalabim.__version__
# The full version, including alpha/beta/rc tags.
release = pipsalabim.__version__
...
# [howto/manual]).
latex_documents = [
    ('index', 'pipsalabim.tex',
     u'Pip Sala Bim Documentation',
